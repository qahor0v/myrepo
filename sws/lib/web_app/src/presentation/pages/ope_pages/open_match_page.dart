...
class OpenMatchWebPage extends HookConsumerWidget {
  final MatchEvent event;

  const OpenMatchWebPage({
    super.key,
    required this.event,
  });
  ...
  Widget build(BuildContext context, ref) {
    ...
    return WebBackWrapper(
      child: Scaffold(
        drawer: isMobile ? const WebSidebar(index: 99) : null,
        appBar: isMobile
            ? AppBar(
        ...
        body: Center(
          child: SizedBox(
            width:
                isDesktop || isTablet ? 800 : MediaQuery.of(context).size.width,
            child: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    HBox(16.0),
                     if (isDesktop || isTablet) const WebAppBar(),
                     HBox(48.0),
                    Row(
                      children: [
                        Expanded(
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  if (event
                                      .lineup.home.starting_lineups.isNotEmpty)
                                    Text(
                                      "Asosiy tarkib",
                                      style: GoogleFonts.roboto(
                                        color: mainColor,
                                  ...
                                  if (event
                                      .lineup.home.starting_lineups.isNotEmpty)
                                    ...event.lineup.home.starting_lineups
                                        .map((e) {
                                      return Text(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  if (event
                                      .lineup.away.starting_lineups.isNotEmpty)
                                    Text(
                                      "Asosiy tarkib",
                                      style: GoogleFonts.roboto(
                                        color: mainColor,
                                  ...
                                  if (event
                                      .lineup.away.starting_lineups.isNotEmpty)
                                    ...event.lineup.away.starting_lineups
                                        .map((e) {
                                      return Text(
                                        "${e.lineup_number}.${e.lineup_player}",
                                        style: GoogleFonts.roboto(
